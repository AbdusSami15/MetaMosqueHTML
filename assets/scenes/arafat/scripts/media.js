// assets/scenes/arafat/scripts/media.js
// Common media handling for Arafat scene using standard HUD elements
...
export function playTriggerMedia(ctx, item, options = {}) {
    ...
    Promise.all([videoEl.play(), audioEl.play()]).catch((e) => {
        console.warn("[Arafat] Play interrupted or failed:", e);
    });
}
